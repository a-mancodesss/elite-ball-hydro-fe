...
export default function ProjectMap({ summaries, lakes, height = "560px" }: Props) {
  return (
    <div
      className="rounded-lg overflow-hidden border border-slate-200 relative"
      style={{ height }}
    >
      <MapContainer
      ...
      <div className="absolute bottom-3 left-3 z-[400] bg-white/95 backdrop-blur rounded-md shadow border border-slate-200 px-3 py-2 text-xs space-y-1">
